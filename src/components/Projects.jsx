        ...
        <div className="space-y-32">
          {portfolioData.projects.map((project, idx) => (
            ...
            >
              ...
              >
                <div
                  className={`glass-morphism p-8 rounded-2xl relative z-10 ${idx % 2 === 0 ? '-ml-0 lg:-ml-20' : '-mr-0 lg:-mr-20'
                    }`}
                >
                  ...
                  {/* Impacts/Contributions Section */}
                  {project.impacts && project.impacts.length > 0 && (
                    <div className="mb-6">
                      <p className="font-mono text-primary text-xs mb-3 uppercase tracking-wide">
                        ↳ Key Outcomes
                      </p>
